## 02c_simulate_and_recover_diag.R
## Reduced-scale estimation: 60 synthetic subjects, diagonal omega.
## 100 burn-in and 100 estimation iterations; Day 1/8 sampling by default.
## Source of the reported point estimates, executed September 2026.
## The recorded session exited during the covariance/SE step; see R/README.md.
## Synthetic estimation demonstration; patient-level trial data are not public.
## RUN FROM THE REPOSITORY ROOT: source("R/02c_simulate_and_recover_diag.R")
...
## assess fixed-effect and marginal IIV recovery -- it does not
...
cat("(omega V2-CL correlation ~67%) are not estimated here.\n")
